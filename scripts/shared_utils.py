...
def load_config_xlsx(xlsx_path: str) -> dict:
    ...
    sheet_parsers = {
        ...
        "0-Classification": ("classification", _parse_classification_sheet),
        "0-Profiling Flags": ("profiling_flags", _parse_profiling_flags_sheet),
        "0-Tables": ("tables", _parse_tables_sheet),
        "0-Priority Scoring": ("priority_scoring", _parse_priority_scoring_sheet),
        "0-Search Terms": ("search_terms", _parse_search_terms_sheet),
        "1-Acronym Finder": ("acronym_finder", _parse_acronym_finder_sheet),
        "2-Control Extraction": ("control_extraction", _parse_control_extraction_sheet),
        "3-Cross References": ("cross_references", _parse_cross_references_sheet),
        "4-Headings": ("headings", _parse_headings_sheet),
        "4-Text Deletions": ("text_deletions", _parse_text_deletions_sheet),
        "5-Sections": ("sections", _parse_sections_sheet),
        "5-Thresholds": ("thresholds", _parse_thresholds_sheet),
        "6-Metadata": ("metadata", _parse_metadata_sheet),
        "7-Docx2md": ("docx2md", _parse_docx2md_sheet),
        "8-Docx2jsonl": ("docx2jsonl", _parse_docx2jsonl_sheet),
