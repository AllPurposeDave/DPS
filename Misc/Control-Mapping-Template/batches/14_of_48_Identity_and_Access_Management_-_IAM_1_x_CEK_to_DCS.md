# Batch: [14/48] Identity & Access Management - IAM (part 1) × Families: CEK, DCS
...
**Save the output as:** `results/14_of_48_Identity_and_Access_Management_-_IAM_1_x_CEK_to_DCS_result.json`
