# Batch: [70/72] Security Incident Management, E-Discovery, & Cloud Forensics - SEF × Families: IPY, I&S, LOG
...
**Save the output as:** `results/70_of_72_Security_Incident_Management,_E-Discover_x_IPY_to_LOG_result.json`
