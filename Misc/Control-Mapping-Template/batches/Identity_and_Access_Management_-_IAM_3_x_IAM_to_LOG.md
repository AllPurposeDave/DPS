# Batch: Identity & Access Management - IAM (part 3) × Families: IAM, IPY, I&S, LOG
...
**Save the output as:** `results/Identity_and_Access_Management_-_IAM_3_x_IAM_to_LOG_result.json`
