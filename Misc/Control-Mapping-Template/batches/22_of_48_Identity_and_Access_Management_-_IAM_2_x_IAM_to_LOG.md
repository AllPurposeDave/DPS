# Batch: [22/48] Identity & Access Management - IAM (part 2) × Families: IAM, IPY, I&S, LOG
...
**Save the output as:** `results/22_of_48_Identity_and_Access_Management_-_IAM_2_x_IAM_to_LOG_result.json`
