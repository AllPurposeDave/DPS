# Batch: [2/48] Change Control and Configuration Management - CCC × Families: CEK, DCS
...
**Save the output as:** `results/02_of_48_Change_Control_and_Configuration_Managem_x_CEK_to_DCS_result.json`
