# Batch: [30/48] Identity & Access Management - IAM (part 3) × Family: UEM
...
**Save the output as:** `results/30_of_48_Identity_and_Access_Management_-_IAM_3_x_UEM_result.json`
