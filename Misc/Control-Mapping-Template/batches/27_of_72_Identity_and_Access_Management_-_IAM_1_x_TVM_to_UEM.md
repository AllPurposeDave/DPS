# Batch: [27/72] Identity & Access Management - IAM (part 1) × Families: TVM, UEM
...
**Save the output as:** `results/27_of_72_Identity_and_Access_Management_-_IAM_1_x_TVM_to_UEM_result.json`
