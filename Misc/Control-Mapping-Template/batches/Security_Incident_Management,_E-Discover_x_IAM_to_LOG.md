# Batch: Security Incident Management, E-Discovery, & Cloud Forensics - SEF × Families: IAM, IPY, I&S, LOG
...
**Save the output as:** `results/Security_Incident_Management,_E-Discover_x_IAM_to_LOG_result.json`
