# Batch: [18/72] Data Security and Privacy Lifecycle Management - DSP × Families: TVM, UEM
...
**Save the output as:** `results/18_of_72_Data_Security_and_Privacy_Lifecycle_Mana_x_TVM_to_UEM_result.json`
