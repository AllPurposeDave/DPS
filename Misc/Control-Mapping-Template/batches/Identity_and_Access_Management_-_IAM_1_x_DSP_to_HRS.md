# Batch: Identity & Access Management - IAM (part 1) × Families: DSP, GRC, HRS
...
**Save the output as:** `results/Identity_and_Access_Management_-_IAM_1_x_DSP_to_HRS_result.json`
