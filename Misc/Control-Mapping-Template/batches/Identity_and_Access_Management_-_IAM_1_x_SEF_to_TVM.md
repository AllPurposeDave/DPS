# Batch: Identity & Access Management - IAM (part 1) × Families: SEF, STA, TVM
...
**Save the output as:** `results/Identity_and_Access_Management_-_IAM_1_x_SEF_to_TVM_result.json`
