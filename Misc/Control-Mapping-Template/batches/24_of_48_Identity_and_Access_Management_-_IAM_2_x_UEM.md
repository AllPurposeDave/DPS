# Batch: [24/48] Identity & Access Management - IAM (part 2) × Family: UEM
...
**Save the output as:** `results/24_of_48_Identity_and_Access_Management_-_IAM_2_x_UEM_result.json`
