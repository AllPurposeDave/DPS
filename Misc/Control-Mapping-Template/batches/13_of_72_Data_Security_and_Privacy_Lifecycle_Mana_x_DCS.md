# Batch: [13/72] Data Security and Privacy Lifecycle Management - DSP × Family: DCS
...
**Save the output as:** `results/13_of_72_Data_Security_and_Privacy_Lifecycle_Mana_x_DCS_result.json`
