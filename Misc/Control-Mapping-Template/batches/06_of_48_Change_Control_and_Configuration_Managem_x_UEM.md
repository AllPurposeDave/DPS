# Batch: [6/48] Change Control and Configuration Management - CCC × Family: UEM
...
**Save the output as:** `results/06_of_48_Change_Control_and_Configuration_Managem_x_UEM_result.json`
