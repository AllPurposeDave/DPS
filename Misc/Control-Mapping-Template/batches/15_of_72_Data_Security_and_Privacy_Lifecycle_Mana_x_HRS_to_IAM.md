# Batch: [15/72] Data Security and Privacy Lifecycle Management - DSP × Families: HRS, IAM
...
**Save the output as:** `results/15_of_72_Data_Security_and_Privacy_Lifecycle_Mana_x_HRS_to_IAM_result.json`
