# Batch: Data Security and Privacy Lifecycle Management - DSP × Families: DSP, GRC, HRS
...
**Save the output as:** `results/Data_Security_and_Privacy_Lifecycle_Mana_x_DSP_to_HRS_result.json`
