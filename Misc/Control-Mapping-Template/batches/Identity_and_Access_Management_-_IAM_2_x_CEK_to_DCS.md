# Batch: Identity & Access Management - IAM (part 2) × Families: CEK, DCS
...
**Save the output as:** `results/Identity_and_Access_Management_-_IAM_2_x_CEK_to_DCS_result.json`
