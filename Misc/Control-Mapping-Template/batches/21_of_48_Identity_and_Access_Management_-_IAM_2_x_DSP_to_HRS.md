# Batch: [21/48] Identity & Access Management - IAM (part 2) × Families: DSP, GRC, HRS
...
**Save the output as:** `results/21_of_48_Identity_and_Access_Management_-_IAM_2_x_DSP_to_HRS_result.json`
