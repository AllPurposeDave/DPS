# Batch: [23/48] Identity & Access Management - IAM (part 2) × Families: SEF, STA, TVM
...
**Save the output as:** `results/23_of_48_Identity_and_Access_Management_-_IAM_2_x_SEF_to_TVM_result.json`
