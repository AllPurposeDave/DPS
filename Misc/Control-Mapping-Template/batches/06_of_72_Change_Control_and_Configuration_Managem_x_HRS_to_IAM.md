# Batch: [6/72] Change Control and Configuration Management - CCC × Families: HRS, IAM
...
**Save the output as:** `results/06_of_72_Change_Control_and_Configuration_Managem_x_HRS_to_IAM_result.json`
