# Batch: Data Security and Privacy Lifecycle Management - DSP × Families: SEF, STA, TVM
...
**Save the output as:** `results/Data_Security_and_Privacy_Lifecycle_Mana_x_SEF_to_TVM_result.json`
