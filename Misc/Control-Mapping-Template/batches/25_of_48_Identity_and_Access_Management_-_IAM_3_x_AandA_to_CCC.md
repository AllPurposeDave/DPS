# Batch: [25/48] Identity & Access Management - IAM (part 3) × Families: A&A, AIS, BCR, CCC
...
**Save the output as:** `results/25_of_48_Identity_and_Access_Management_-_IAM_3_x_AandA_to_CCC_result.json`
