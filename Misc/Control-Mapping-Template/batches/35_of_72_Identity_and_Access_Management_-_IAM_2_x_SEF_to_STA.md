# Batch: [35/72] Identity & Access Management - IAM (part 2) × Families: SEF, STA
...
**Save the output as:** `results/35_of_72_Identity_and_Access_Management_-_IAM_2_x_SEF_to_STA_result.json`
