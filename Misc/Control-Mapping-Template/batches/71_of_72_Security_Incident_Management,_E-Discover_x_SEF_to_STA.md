# Batch: [71/72] Security Incident Management, E-Discovery, & Cloud Forensics - SEF × Families: SEF, STA
...
**Save the output as:** `results/71_of_72_Security_Incident_Management,_E-Discover_x_SEF_to_STA_result.json`
