# Batch: [45/72] Identity & Access Management - IAM (part 3) × Families: TVM, UEM
...
**Save the output as:** `results/45_of_72_Identity_and_Access_Management_-_IAM_3_x_TVM_to_UEM_result.json`
