# Batch: [16/48] Identity & Access Management - IAM (part 1) × Families: IAM, IPY, I&S, LOG
...
**Save the output as:** `results/16_of_48_Identity_and_Access_Management_-_IAM_1_x_IAM_to_LOG_result.json`
