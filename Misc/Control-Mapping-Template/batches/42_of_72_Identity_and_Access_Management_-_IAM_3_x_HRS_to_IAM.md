# Batch: [42/72] Identity & Access Management - IAM (part 3) × Families: HRS, IAM
...
**Save the output as:** `results/42_of_72_Identity_and_Access_Management_-_IAM_3_x_HRS_to_IAM_result.json`
