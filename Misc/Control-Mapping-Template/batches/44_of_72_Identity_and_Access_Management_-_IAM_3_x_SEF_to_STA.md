# Batch: [44/72] Identity & Access Management - IAM (part 3) × Families: SEF, STA
...
**Save the output as:** `results/44_of_72_Identity_and_Access_Management_-_IAM_3_x_SEF_to_STA_result.json`
