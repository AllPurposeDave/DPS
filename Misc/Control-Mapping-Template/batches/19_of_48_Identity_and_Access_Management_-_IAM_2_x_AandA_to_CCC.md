# Batch: [19/48] Identity & Access Management - IAM (part 2) × Families: A&A, AIS, BCR, CCC
...
**Save the output as:** `results/19_of_48_Identity_and_Access_Management_-_IAM_2_x_AandA_to_CCC_result.json`
