# Batch: [37/72] Identity & Access Management - IAM (part 3) × Families: A&A, AIS, BCR
...
**Save the output as:** `results/37_of_72_Identity_and_Access_Management_-_IAM_3_x_AandA_to_BCR_result.json`
