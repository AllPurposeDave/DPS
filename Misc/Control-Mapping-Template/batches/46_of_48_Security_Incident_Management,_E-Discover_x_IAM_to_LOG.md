# Batch: [46/48] Security Incident Management, E-Discovery, & Cloud Forensics - SEF × Families: IAM, IPY, I&S, LOG
...
**Save the output as:** `results/46_of_48_Security_Incident_Management,_E-Discover_x_IAM_to_LOG_result.json`
