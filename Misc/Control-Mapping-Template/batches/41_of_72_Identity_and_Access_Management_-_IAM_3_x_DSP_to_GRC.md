# Batch: [41/72] Identity & Access Management - IAM (part 3) × Families: DSP, GRC
...
**Save the output as:** `results/41_of_72_Identity_and_Access_Management_-_IAM_3_x_DSP_to_GRC_result.json`
