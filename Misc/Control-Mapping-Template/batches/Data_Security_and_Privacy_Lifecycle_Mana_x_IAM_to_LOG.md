# Batch: Data Security and Privacy Lifecycle Management - DSP × Families: IAM, IPY, I&S, LOG
...
**Save the output as:** `results/Data_Security_and_Privacy_Lifecycle_Mana_x_IAM_to_LOG_result.json`
