# Batch: Change Control and Configuration Management - CCC × Families: DSP, GRC, HRS
...
**Save the output as:** `results/Change_Control_and_Configuration_Managem_x_DSP_to_HRS_result.json`
