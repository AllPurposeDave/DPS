# Batch: [34/72] Identity & Access Management - IAM (part 2) × Families: IPY, I&S, LOG
...
**Save the output as:** `results/34_of_72_Identity_and_Access_Management_-_IAM_2_x_IPY_to_LOG_result.json`
