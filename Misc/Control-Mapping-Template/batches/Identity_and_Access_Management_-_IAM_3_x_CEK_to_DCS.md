# Batch: Identity & Access Management - IAM (part 3) × Families: CEK, DCS
...
**Save the output as:** `results/Identity_and_Access_Management_-_IAM_3_x_CEK_to_DCS_result.json`
