# Batch: [33/48] Interoperability & Portability - IPY × Families: DSP, GRC, HRS
...
**Save the output as:** `results/33_of_48_Interoperability_and_Portability_-_IPY_x_DSP_to_HRS_result.json`
