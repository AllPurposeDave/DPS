# Batch: [14/72] Data Security and Privacy Lifecycle Management - DSP × Families: DSP, GRC
...
**Save the output as:** `results/14_of_72_Data_Security_and_Privacy_Lifecycle_Mana_x_DSP_to_GRC_result.json`
