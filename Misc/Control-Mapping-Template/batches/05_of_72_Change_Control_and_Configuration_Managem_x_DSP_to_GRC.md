# Batch: [5/72] Change Control and Configuration Management - CCC × Families: DSP, GRC
...
**Save the output as:** `results/05_of_72_Change_Control_and_Configuration_Managem_x_DSP_to_GRC_result.json`
