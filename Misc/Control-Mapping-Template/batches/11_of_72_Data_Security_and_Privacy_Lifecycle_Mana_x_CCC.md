# Batch: [11/72] Data Security and Privacy Lifecycle Management - DSP × Family: CCC
...
**Save the output as:** `results/11_of_72_Data_Security_and_Privacy_Lifecycle_Mana_x_CCC_result.json`
