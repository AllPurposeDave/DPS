# Batch: [36/72] Identity & Access Management - IAM (part 2) × Families: TVM, UEM
...
**Save the output as:** `results/36_of_72_Identity_and_Access_Management_-_IAM_2_x_TVM_to_UEM_result.json`
