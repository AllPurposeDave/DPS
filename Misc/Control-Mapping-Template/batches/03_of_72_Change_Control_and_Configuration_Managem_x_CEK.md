# Batch: [3/72] Change Control and Configuration Management - CCC × Family: CEK
...
**Save the output as:** `results/03_of_72_Change_Control_and_Configuration_Managem_x_CEK_result.json`
