# Batch: Interoperability & Portability - IPY × Families: A&A, AIS, BCR, CCC
...
**Save the output as:** `results/Interoperability_and_Portability_-_IPY_x_AandA_to_CCC_result.json`
