# Batch: [32/48] Interoperability & Portability - IPY × Families: CEK, DCS
...
**Save the output as:** `results/32_of_48_Interoperability_and_Portability_-_IPY_x_CEK_to_DCS_result.json`
