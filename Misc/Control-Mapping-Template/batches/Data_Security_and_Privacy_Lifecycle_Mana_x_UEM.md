# Batch: Data Security and Privacy Lifecycle Management - DSP × Family: UEM
...
**Save the output as:** `results/Data_Security_and_Privacy_Lifecycle_Mana_x_UEM_result.json`
