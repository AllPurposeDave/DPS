# Batch: [40/72] Identity & Access Management - IAM (part 3) × Family: DCS
...
**Save the output as:** `results/40_of_72_Identity_and_Access_Management_-_IAM_3_x_DCS_result.json`
